...
def load_wrapper(device='cuda'):
    # model_id = 'CompVis/stable-diffusion-v1-4'
    # https://huggingface.co/sug567/stable-diffusion-v2.1-clone
    # use clone because 2.1 is deprecated apparently 
    model_id = 'sug567/stable-diffusion-v2.1-clone'
    seed = 2000
    timesteps_inference = 50 #/////
    scheduler = DDIMScheduler.from_pretrained(model_id, subfolder='scheduler')
    print("Scheduler loaded.")
    pipe = StableDiffusionWrapper.from_pretrained(model_id, scheduler=scheduler, torch_dtype=torch.float32)
